...
VQQKEw1MZXQncyBFbmNyeXB0MQwwCgYDVQQDEwNZRTcwdjAQBgcqhkjOPQIBBgUr
...
jDdFsbzYMB8GA1UdIwQYMBaAFKPIJlqOoUzQNWP8myPIOq5W809WMDIGCCqGSM49
BwEBBCYwJDAiBggrBgEFBQcwAoYWaHR0cDovL3llLmkubGVuY3Iub3JnLzATBgNV
HSAEDDAKMAgGBmeBDAECATAnBgNVHR8EIDAeMBygGqAYhhZodHRwOi8veWUuYy5s
ZW5jci5vcmcvMAoGCCqGSM49BAMDA2gAMGUCMQDgjUEahFT/h3DRakqiPZLvPgf
...
void setup() {
  ...
  if (!Wire.begin(
    ...
    Serial.println(
      "⚠ SHT45 não encontrado — continuando sem o sensor");
    ...
    Serial.println(
      "✅ Sensor SHT45 iniciado com sucesso");
  }
...
void connectWiFi() {
  ...
  while (
    ...
    if (
      ...
      Serial.println(
        "❌ WiFi não conectou — tentativa encerrada");
